...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<p><a href="#" class="shipping-calculator-button btn btn-secondary muted btn-small"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></p>

	<section class="shipping-calculator-form" style="display:none;">

		<p class="form-row form-row-wide">
			<select class="no-uniform" name="calc_shipping_country" id="calc_shipping_country" class="country_to_state" rel="calc_shipping_state">
		...
		<p class="form-row form-row-wide">
			<?php
				...
				// Dropdown Input
					...
					?><span>
						<select class="no-uniform" name="calc_shipping_state" id="calc_shipping_state" placeholder="<?php _e( 'State / county', 'woocommerce' ); ?>">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn btn-grey"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
